...
<div class="row">
    <div class="col-lg-8 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Buat Peran Baru</h4>
                <p class="card-description">
                    Isi formulir di bawah untuk menambahkan peran baru ke sistem.
                </p>
                ...
                <form action="{{ route('roles.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: admin, editor, user" required>
                    </div>
