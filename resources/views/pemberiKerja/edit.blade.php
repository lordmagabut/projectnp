  ...
  <div class="col-12 grid-margin stretch-card">
    <div class="card shadow-sm">
      <div class="card-header d-flex align-items-center justify-content-between flex-wrap">
        <h5 class="mb-0">Edit Pemberi Kerja</h5>
      ...
      <div class="card-body">
        ...
        @if ($errors->any())
          <div class="alert alert-danger">
            <div class="fw-semibold mb-1">Gagal mengupdate:</div>
            <ul class="mb-0">
        ...
        <form action="{{ route('pemberiKerja.update', $pemberiKerja->id) }}" method="POST" novalidate>
          @csrf
          @method('PUT')
          ...
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" id="nama_pemberi_kerja" name="nama_pemberi_kerja"
                     ...
                     value="{{ old('nama_pemberi_kerja', $pemberiKerja->nama_pemberi_kerja) }}" required>
            ...
            <div class="col-md-6">
              ...
              <input type="text" id="pic" name="pic"
                     ...
                     value="{{ old('pic', $pemberiKerja->pic) }}">
            ...
            <div class="col-md-6">
              ...
              <input type="text" id="jabatan_pic" name="jabatan_pic"
                     ...
                     value="{{ old('jabatan_pic', $pemberiKerja->jabatan_pic) }}">
            ...
            <div class="col-md-6">
              ...
              <input type="text" id="no_kontak" name="no_kontak"
                     ...
                     value="{{ old('no_kontak', $pemberiKerja->no_kontak) }}">
            ...
            <div class="col-md-6">
              ...
              <input type="text" id="nama_direktur" name="nama_direktur"
                     ...
                     value="{{ old('nama_direktur', $pemberiKerja->nama_direktur) }}">
            ...
            <div class="col-md-6">
              ...
              <input type="text" id="jabatan_direktur" name="jabatan_direktur"
                     ...
                     value="{{ old('jabatan_direktur', $pemberiKerja->jabatan_direktur) }}">
            ...
            <div class="col-12">
              ...
              <textarea id="alamat" name="alamat" rows="3"
                        class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $pemberiKerja->alamat) }}</textarea>
